...
%\bibitem{Roth} Michael S. Roth. \textit{Philosophy, Modernity, and Intellectual History, part 1 of 2.} \textsl{// Video lecture, 2013.}
%\bibitem{Kant} Immanuel Kant.  \textit{An Answer to the Question: ``What is Enlightenment?''} \textsl{// K\"onigsberg in Prussia, 30th September, 1784.}
%\bibitem{Confessions} Jean-Jacques Rousseau. \textit{The Confessions.} \textsl{// Geneve, 1782.}
%\bibitem{discourse2} Jean-Jacques Rousseau. \textit{Discourse on the Origin and Basis of Inequality Among Men.} \textsl{// Amsterdam, 1755.}
%\bibitem{stanford} \myhref{http://plato.stanford.edu/entries/rousseau/}{Jean Jacques Rousseau. Stanford Encyclopedia of Philosophy.}
%\bibitem{clewis} Robert R. Clewis. \textit{Kant's Conception of Philosophy.} \textsl{// International Kant Congress (Pisa), 2012.}
%\bibitem{propagator} Susan Shell.  \textit{Kant as Propagator: Reflections on ``Observations on the Feeling of the Beautiful and Sublime''.}
%\textsl{// Eighteenth-Century Studies.  Vol. 35, No. 3, Aesthetics and the Disciplines (Spring, 2002), pp. 455-468.}
%\end{thebibliography}
\end{document}
